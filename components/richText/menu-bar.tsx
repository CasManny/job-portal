...
import { Bold, Heading1, Heading2, Italic, ListIcon, ListOrdered, Strikethrough } from "lucide-react";
...
const MenuBar = ({ editor }: IAppProps) => {
  ...
  return (
    <div className="border items-center rounded-t-lg  p-2 bg-card flex flex-wrap gap-1">
      <TooltipProvider>
